...
<!-- listAll----------------------------------------------------------------------------------------------------------->
	<div id="content" class="container-fluid">
		<div class="content">
				...
				<div class="list-option">
					<div class="list-option-inner">
						<select class="form-control" onchange="if(this.value) location.href=(this.value);">
							...
							<option value="/category/boonsikStarSort" selected>별점순</option>
							<option value="/category/boonsikReviewSort">리뷰 많은순</option>
			...
			<div>
				<div>
					...
					<div class="restaurant-list">
						<c:forEach items="${listBoonsikStarSort}" var="store">
						<div class="col-sm-6">
			...
			<c:if test="${empty listBoonsikStarSort}">
