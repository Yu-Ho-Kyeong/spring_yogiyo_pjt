		...
		<div class="login-wrap">
			...
			<form class="form-login" method="post">
				<div class="login-form">
					...
					<h1>회원정보확인</h1>
					<p><strong>${member.memberId}</strong>님의 정보를 안전하게 보호하기 위해 비밀번호를 다시 한번 확인 합니다.</p>	
					
					<ul class="list-group">
						<li class="list-group-item">
							<label>아이디</label>
							<input type="text"id="id-input" name="memberId" placeholder="아이디를 입력해주세요"/>
							<span class= "final-id-ck">아이디를 입력해주세요.</span>
						</li>

						<li class="list-group-item">
						<label>비밀번호</label>
							<input type="password" id="pwd-input" name="memberPwd" placeholder="비밀번호 를 입력해주세요" />
				...
				<button type="submit" class="btn btn_login">확인</button>
	...
	<script>
		...
		$(document).ready(function(){
			$(".btn_login").click(function() { //확인 버튼
				...
				if(pwdCheck, idCheck == true){
					$(".form-login").attr("action", "/member/memberDelete");
					$(".form-login").submit();
				}
			});
