...
<!-- listAll----------------------------------------------------------------------------------------------------------->
	<div id="content" class="container-fluid">
		<div class="content">
				...
				<div class="list-option">
					<div class="list-option-inner">
						<select class="form-control" onchange="if(this.value) location.href=(this.value);">
							<option value="/category/all">기본 정렬순</option>
							<option value="/category/allStarSort">별점순</option>
							<option value="/category/allReviewSort" selected>리뷰 많은순</option>
			...
			<div>
				<div>
					...
					<div class="restaurant-list">
						<c:forEach items="${listAllReviewSort}" var="store">
						<div class="col-sm-6">
											...
											<td>
												<div class="restaurants-info" >
													...
													<div class="stars">
														...
														<c:if test="${store.storeReviewCnt == 0}">
			...
			<c:if test="${empty listAllReviewSort}">
