				...
				<div class="list-option">
					<div class="list-option-inner">
						<select class="form-control" onchange="if(this.value) location.href=(this.value);">
							<option value="/category/all" selected>기본 정렬순</option>
							<option value="/category/allStarSort">별점순</option>
							<option value="/category/allReviewSort">리뷰 많은순</option>
			...
			<div>
				<div>
					...
					<div class="restaurant-list">
						<c:forEach items="${listAll}" var="store">
						<div class="col-sm-6">
									...
									<tbody>
										<tr onclick="location.href='/store/storeDetail?storeNo=${store.storeNo}'">
											<td>
												...
												<!-- <div class="logo not-available ng-hide" style="background-image: url(&quot;/img/default_restaurant_logo.png&quot;);">
											...
											<td>
												<div class="restaurants-info" >
													...
													<ul>
														...
														<li class="min-price"><fmt:formatNumber value="${store.storeMinPrice}" pattern="#,###,###" />원 이상 배달 </li>											
														<li class="full-w">
		...
		<div class="page_container">
		  <ul>
		    <c:if test="${pageMaker.prev}">
		    	<li class="paging"><a class="btn-paging" href="/category/all${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
		    </c:if> 
		
		    <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
		    	<li class="paging"><a class="btn-paging" href="/category/all${pageMaker.makeQuery(idx)}">${idx}</a></li>
		    </c:forEach>
		
		    <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
		    	<li class="paging"><a class="btn-paging" href="/category/all${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
		    </c:if> 
		  </ul>
		</div>
	</div>
