...
<!-- listAll----------------------------------------------------------------------------------------------------------->
	<div id="content" class="container-fluid">
		<div class="content">
				...
				<div class="list-option">
					<div class="list-option-inner">
						<select class="form-control" onchange="if(this.value) location.href=(this.value);">
							...
							<option value="/category/allStarSort" selected>별점순</option>
			...
			<div>
				<div>
					...
					<div class="restaurant-list">
						<c:forEach items="${listAllStarSort}" var="store">
						<div class="col-sm-6">
											...
											<td>
												<div class="restaurants-info" >
													...
													<ul>
														...
														<li class="min-price">
															<fmt:formatNumber value="${store.storeMinPrice}" pattern="#,###,###" />원 이상 배달 
														</li>											
														<li class="full-w">
			...
			<c:if test="${empty listAllStarSort}">
